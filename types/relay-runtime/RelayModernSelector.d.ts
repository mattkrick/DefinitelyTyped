...
export function getSelector(operationVariables: Variables, fragment: ReaderFragment, item: {}, explicitOwner?: OperationDescriptor | null): OwnedReaderSelector | undefined | null
export function getSelectorList(operationVariables: Variables, fragment: ReaderFragment, items: Array<{}>, owners?: Array<OperationDescriptor | undefined | null>): Array<OwnedReaderSelector> | undefined | null

export function getSelectorsFromObject(operationVariables: Variables, fragments: {
...
export function getDataIDsFromObject(fragments: {
  [key: string]: ReaderFragment;
}, object: {
  [key: string]: {};
}): {
