...
export type DeclarativeMutationConfig = RangeAddConfig | RangeDeleteConfig | NodeDeleteConfig | LegacyFieldsChangeConfig | LegacyRequiredChildrenConfig;

export function convert(configs: Array<DeclarativeMutationConfig>, request: ConcreteRequest, optimisticUpdater?: SelectorStoreUpdater | null, updater?: SelectorStoreUpdater | null): void
