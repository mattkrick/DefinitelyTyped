...
import {CacheConfig, Variables} from "./RelayRuntimeTypes";
...
export type ExecuteFunction = (request: RequestParameters, variables: Variables, cacheConfig: CacheConfig, uploadables: UploadableMap | undefined | null) => RelayObservable<GraphQLResponse>;
/**
...
export type FetchFunction = (request: RequestParameters, variables: Variables, cacheConfig: CacheConfig, uploadables: UploadableMap | undefined | null) => ObservableFromValue<GraphQLResponse>;
/**
...
export type SubscribeFunction = (request: RequestParameters, variables: Variables, cacheConfig: CacheConfig, observer: LegacyObserver<GraphQLResponse>) => RelayObservable<GraphQLResponse> | Disposable; // $FlowFixMe(site=react_native_fb) this is compatible with classic api see D4658012
